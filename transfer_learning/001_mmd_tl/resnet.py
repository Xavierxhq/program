...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.conv1 = nn.Conv2d(in_channels=1, out_channels=64, kernel_size=7, stride=1, padding=3,
                               bias=False)
...
class DANNet(nn.Module):
    ...
    def __init__(self, num_classes=2, print_mmd_loss=False):
        super(DANNet, self).__init__()
        self.print_mmd_loss = print_mmd_loss
        self.sharedNet = resnet18()
        self.cls_fc = nn.Linear(512, num_classes)
        print('DANNet model load.')
...
class ResNet18(nn.Module):
    ...
    def __init__(self, num_classes=2):
        ...
        self.sharedNet = resnet18() # set False to load a new model
        self.cls_fc = nn.Linear(512, num_classes)
